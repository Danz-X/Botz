...
var num = "6281252009563@s.whatsapp.net"
var ownerNumber = ["6281252009563@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
...
success: 'Done...Jangam Lupa Subscribe Raditya',
...
status: 1,
surface : 1,
message: `Subscribe Raditya`, 
orderTitle: `Subscribe Raditya`,
thumbnail: fakethumb,
...
「 INFO BOT 」
🎃Creator Bot : '©Created By Raditya'
🌐 Prefix :  ⌜  ${prefix}  ⌟
🍬 Name Bot : ${NameBot}
...
𝐂𝐫𝐞??𝐭𝐨𝐫 𝐒𝐜𝐫𝐢𝐩𝐭 : LeonGanz + ZEROYT07
...
break
case 's&k':
rules = `*「 PERATURAN CLUBY NETWORK 」*

*PLEASE READ THE RULES!*

*_Promosi REALM/SERVER KICK!_*
*_- Dilarang spam_*
*_- Dilarang kirim media 18+, hoax, dan phising_*
*_- Dilarang rusuh_*
*_- Dilarang menghina_*
*_- Dilarang toxic berlebihan_*
*_- Hormati admin_*
*_- Promosi 1 hari 2 kali_*
*_- No Ngemis jadi admin_*
*_- No spam chat_*
*_- No grief/cheating_*
*_- Hormati agama org lain_*
*_- Jangan bahas game lain_*
*_- Jangan bully orang!_*
*_- No Virtex_*`
var ZeroYT7 = {
            contextInfo: {
            participant: '0@s.whatsapp.net',
